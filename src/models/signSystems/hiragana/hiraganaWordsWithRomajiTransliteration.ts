import { hiraganaToRomajiMap } from "./hiraganaToRomaji";
import { wordFromRomaji } from "./hiraganaSignSequenceUtils";
...
export const DBWordToWord = (dbWord: DBWord): Word => {
